...
function Homepage() {
	...
	return (
		<div className="grow 2xl:w-4/6 w-9/12 mx-auto flex  justify-between content-around flex-wrap 2xl:text-md text-sm">
			<div className="text-white flex flex-col h-56 justify-between flex-wrap">
				<div>
					<div className="py-1">
					...
					<div className="py-1">
						<h3 className="text-[#4D5BCE] text-xl font-semibold">
							&gt; Front-end Developer{" "}
						</h3>
					</div>
				</div>
