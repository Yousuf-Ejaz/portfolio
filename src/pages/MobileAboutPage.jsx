...
import MobileInterests from "../components/MobileInterests";
				...
				<div className="flex flex-col">
					...
					<div>
						<div className="text-xs px-5 pt-6">
							...
							<span>&nbsp;/</span>
							<span>{showBio ? ` bio` : ""}</span>
							<span>{showEducation ? ` education` : ""}</span>
							<span>{showInterests ? ` interests` : ""}</span>
						</div>
						<div className="px-5 pt-5">
							{showBio ? <MobileBio /> : <></>}
							{showEducation ? <MobileEducation /> : <></>}
							{showInterests ? <MobileInterests /> : <></>}
						</div>
					</div>
				</div>
			)}
